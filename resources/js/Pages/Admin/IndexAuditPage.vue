<template>
    ...
    <slot>
        <h2 class="text-xl font-heading font-semibold leading-7 text-gray-800 ml-5 mb-5">Activity</h2>
        <div class="container-border mx-5" style="padding:0.5px">
            <DataTable :size="size.value" v-if="audits && audits.length > 0" :value="audits" class="text-xs" ref="dt"
                dataKey="id" v-model:selection="selectedAudit" scrollable scrollHeight="600px" paginator :rows="10"
